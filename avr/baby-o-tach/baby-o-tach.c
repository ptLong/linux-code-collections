...
*   @file   baby-o-tach.c
*
*   @brief  Simple Tachometer using a Baby Orangatang and an HC4LED 
*           display module purchased from SparkFun.
*
****************************************************************************/
...
#define TACH_LED_DDR    DDRC
#define TACH_LED_PORT   PORTC
#define TACH_LED_MASK   ( 1 << 4 )

#define TACH_DDR        DDRB
#define TACH_PIN        PINB
#define TACH_PORT       PORTB
#define TACH_MASK       ( 1 << 0 )
...
//    printf( "GetTimer overflowCount = %04x tcnt = %02x timerCount = %08lx\n",
//            overflowCount, tcnt, timerCount );
...
int main( void )
{
    ...
    printf( "*****\n" );
    printf( "***** Baby Orangatang Tach program\n" );
    printf( "*****\n" );
...
#if 0
                printf( "t1 = %06lu t2 = %06lu, t1 - t2 = %lu, numSamples = %d, rpm = %lu\n",
                        t1, t2, t1 - t2, numSamples, rpm );
#endif
                PutNum( (uint16_t)rpm );
            }
        }
