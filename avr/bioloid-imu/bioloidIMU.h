...
*   @file   bioloidIMU.h
*
*   @brief  Contains definitions for a bioloid IMU sensor.
*
****************************************************************************/

#if !defined( BIOLOID_IMU_H )
#define BIOLOID_IMU_H	   /**< Include Guard							 */
...
#define NUM_CONTROL_ENTRIES NUM_IMU_CONTROL_ENTRIES
#define MAX_CONTROL_ENTRY MAX_IMU_CONTROL_ENTRY
...
#define PRESSURE_FRONT_RIGHT_CHANNEL 0
#define PRESSURE_FRONT_LEFT_CHANNEL 1
#define PRESSURE_BACK_LEFT_CHANNEL 2
#define PRESSURE_BACK_RIGHT_CHANNEL 3
